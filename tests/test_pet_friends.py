from app.app import PetFriends
...
def test_add_pets_with_valid_data(name='Ron', animal_type='cat', age='3', pet_photo='images/ron.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Goga', 'cat', '5', 'images/Ron.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='Gogawithoutphoto', animal_type='кот', age='6'):
...
def test_add_photo_at_pet(pet_photo='images/vasya.jpg'):
...
def test_add_pet_negative_age_number(name='Ron', animal_type='cat', age='-3', pet_photo='images/ron.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Ron', animal_type='cat', age='1234', pet_photo='images/ron.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='2', pet_photo='images/ron.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/ron.jpg'):
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Ron', age='3', pet_photo='images/ron.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Ron', animal_type='34562', age='3',
                                                      pet_photo='images/ron.jpg'):
...
def test_get_api_key_with_wrong_password_and_correct_mail(email=valid_email, password=invalid_password):
    '''Проверяем запрос с невалидным паролем и с валидным имейлом.
