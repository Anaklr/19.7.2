...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Murzik', 'cat', '5', 'images/Ron.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Ron', age='2', pet_photo='images/ron.jpg'):
